...
from protobuf import geobuf_pb2 as protobuf_dot_geobuf__pb2
...
_MADISSONDE.fields_by_name['location'].message_type = protobuf_dot_geobuf__pb2._DATA
_SERVERCONTAINER.fields_by_name['typ'].enum_type = _SERVERCONTAINERTYPE
_SERVERCONTAINER.fields_by_name['sonde_updates'].message_type = protobuf_dot_geobuf__pb2._DATA
_SERVERCONTAINER.fields_by_name['sonde_paths'].message_type = protobuf_dot_geobuf__pb2._DATA
_SERVERCONTAINER.fields_by_name['madis_paths'].message_type = protobuf_dot_geobuf__pb2._DATA
_SERVERCONTAINER.fields_by_name['dwd_paths'].message_type = protobuf_dot_geobuf__pb2._DATA
_SERVERCONTAINER.fields_by_name['adsb_updates'].message_type = protobuf_dot_geobuf__pb2._DATA
_SERVERCONTAINER.fields_by_name['adsb_paths'].message_type = protobuf_dot_geobuf__pb2._DATA
